...
def end():
    ...
    group_enemies=[]
    group_enemies.append( Sprite3(files, 0, display_height - 20 - height - 20, 5.0, 5))
    group_enemies.append( Sprite3(files, 0, display_height - 20 - height + 0,  9.0, 4))
    group_enemies.append( Sprite3(files, 0, display_height - 20 - height + 10, 8.0, 3))
    group_enemies.append( Sprite3(files, 0, display_height - 20 - height - 20, 8.0, 2))
    group_enemies.append( Sprite3(files, 0, display_height - 20 - height + 0,  5.0, 1))
    group_enemies.append( Sprite3(files, 0, display_height - 20 - height + 15, 4.0, 5))
    group_enemies.append( Sprite3(files, 0, display_height - 20 - height - 20, 3.0, 4))
    group_enemies.append( Sprite3(files, 0, display_height - 20 - height + 10,  2.0, 3))
    group_enemies.append( Sprite3(files, 0, display_height - 20 - height + 15, 3.0, 5))
    ...
    group_enemies.append( Sprite3(files, 0, y0 + 10, 2, 0))
    
    y0 = display_height - map_gap - filesRunSize[1]
    group_enemies.append( Sprite3(files, 0, y0 - 10, 3, 0))
...
def engine_loop():
    ...
    group_enemies.append( Sprite3(files, 0, display_height - map_gap - 77 + 10, 2.0, 0))
    group_enemies.append( Sprite3(files, 0, display_height - map_gap - 77 + 5, 5.0, 0))
