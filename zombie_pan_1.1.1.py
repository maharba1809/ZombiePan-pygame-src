...
class Sprite3(pygame.sprite.Sprite):
    def __init__(self, files, x, y, w, h, u, v):
        super(Sprite3, self).__init__()
        self.images = []
        for item in files:
            self.image = pygame.image.load(item)
            self.image = pygame.transform.scale(self.image, (w, h))
...
def end():
    ...
    files = ['assets/Run1.png', 'assets/Run2.png', 'assets/Run3.png', 'assets/Run4.png', 'assets/Run5.png', 'assets/Run6.png']
    group_enemies=[]
    group_enemies.append(Sprite3(files, 0, display_height - 20 - 77 - 20, 70, 77, 2.0, 0))
    group_enemies.append(Sprite3(files, 0, display_height - 20 - 77 + 0, 70, 77, 2.0, 0))
    group_enemies.append( Sprite3(files, 0, display_height - 20 - 77 + 20, 70, 77, 2.0, 0))
...
def engine_loop():
    ...
    files = ['assets/Run1.png', 'assets/Run2.png', 'assets/Run3.png', 'assets/Run4.png', 'assets/Run5.png', 'assets/Run6.png']
    group_enemies=[]
    group_enemies.append(Sprite3(files, 0, display_height - map_gap - 77 - 10, 70, 77, 2.0, 0))
    group_enemies.append(Sprite3(files, 0, display_height - map_gap - 77 + 0, 70, 77, 2.0, 0))
    group_enemies.append( Sprite3(files, 0, display_height - map_gap - 77 + 10, 70, 77, 2.0, 0))
    
    files = ['assets/helicopter1.png', 'assets/helicopter2.png', 'assets/helicopter3.png', 'assets/helicopter4.png']    
    hel = Sprite3(files, 0, 20, 210, 62, 2, 0)    
    ...
    while not engineExit:
        ...
        if hel.rect.x > display_width - hel.rect.w or hel.rect.x < 0:
           hel.rect.x -= hel.u
           hel.u = 0
